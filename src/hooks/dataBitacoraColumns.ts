...
export const ColumnsBitacoraOpts = {
    ...
    category: [
        ...
        { id: "reportes_y_denuncias", value: "Reportes y denuncias", label: "reportes_y_denuncias" },
        { id: "solicitud_de_empleo", value: "Solicitud de empleo", label: "solicitud_de_empleo" },
        { id: "coyuntura", value: "Coyuntura", label: "coyuntura" },
        { id: "participación_curso", value: "Participación en curso", label: "participación_curso" },
        { id: "solicitud_de_obra", value: "Solicitud de obra", label: "solicitud_de_obra" },
        { id: "otros", value: "Otros", label: "otros" },
    ],
