...
export const ColumnsBitacoraOpts = {
  ...
  area_id: [
    ...
    { id: "desarrollo_económico", value: "Desarrollo económico", label: "desarrollo_económico", color: "oklch(40.1% 0.17 325.612)" },
    { id: "construcción_comunidad", value: "Construcción comunidad", label: "construcción_comunidad", color: "oklch(82.8% 0.111 230.318)" },
    { id: "dif", value: "DIF", label: "dif", color: "oklch(22.8% 0.013 107.4)" },
    ...
    { id: "siapa", value: "SIAPA", label: "siapa", color: "oklch(39.1% 0.09 240.876)" },
    ...
    { id: "inspección_y_vigilancia", value: "Inspección y vigilancia", label: "inspección_y_vigilancia", color: "oklch(14.7% 0.004 49.25)" },
    ...
    { id: "administración_e_innovación_gubernamental", value: "Administración e Innovación Gubernamental", label: "administración_e_innovación_gubernamental", color: "oklch(27.7% 0.046 192.524)" },
  ...
  category: [
    ...
    { id: "solicitudes_nuevas", value: "Solicitudes nuevas", label: "solicitudes_nuevas", color: "oklch(44.3% 0.11 240.79)" },
    ...
    { id: "reporte_de_inspección_y_vigilancia", value: "Reporte de inspección y vigilancia", label: "reporte_de_inspección_y_vigilancia", color: "oklch(21% 0.034 264.665)" },
