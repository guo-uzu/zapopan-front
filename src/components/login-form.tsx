      ...
      <FieldGroup>
        <div className="flex flex-col items-center gap-1 text-center">
          ...
          <p className="text-muted-foreground text-sm text-balance">
            Escribe tu correo y contraseña e inicia sesión
          </p>
        </div>
        <Field>
        ...
        <FieldSeparator>Otras formas de inciar sesión</FieldSeparator>
        <Field>
          <Button disabled={isLoading} onClick={handleSignInWithGoogle} variant="outline" type="button">
